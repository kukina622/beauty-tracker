...
import 'package:beauty_tracker/pages/product/edit_product_page.dart' as _i4;
...
class BrandSettingsRoute extends _i12.PageRouteInfo<void> {
  const BrandSettingsRoute({List<_i12.PageRouteInfo>? children})
...
class EditProductRoute extends _i12.PageRouteInfo<EditProductRouteArgs> {
  ...
  static _i12.PageInfo page = _i12.PageInfo(
    ...
    builder: (data) {
      ...
      return _i4.EditProductPage(key: args.key, productId: args.productId);
    },
  );
}
